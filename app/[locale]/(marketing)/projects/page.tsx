...
const categories = ['All Projects', 'Residential', 'Commercial', 'Restoration']
...
export default function PortfolioPage() {
    ...
    const filteredProjects = projects.filter(p =>
        activeCategory === 'All Projects' || p.category === activeCategory || (activeCategory === 'Restoration' && p.category === 'Restoration')
    )
    ...
    return (
        <main className="flex-grow pt-40 pb-24 px-6 relative overflow-hidden bg-background-dark min-h-screen">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="mb-16 md:mb-24 max-w-3xl animate-in fade-in slide-in-from-bottom-5 duration-1000">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[#e8eade] leading-[1.1] mb-6">
                        Harmonizing nature <br /><span className="text-terracotta font-serif italic">and architecture.</span>
                    </h1>
                    <p className="text-lg md:text-xl text-[#a0a8a3] max-w-xl leading-relaxed font-light">
                        We create bespoke landscapes that breathe. Explore our collection of award-winning sustainable gardens and outdoor living spaces.
                    </p>
                </div>

                {/* Filters */}
                <div className="flex flex-wrap gap-4 mb-16 animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200">
                    {categories.map((cat) => (
                        <button
                            key={cat}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {filteredProjects.map((project, i) => (
                        <div
                            key={project.title}
                            className="group relative rounded-[2.5rem] bg-forest-deep/30 p-3 shadow-portfolio-convex hover:shadow-portfolio-pressed transition-all duration-500 animate-in fade-in slide-in-from-bottom-5"
