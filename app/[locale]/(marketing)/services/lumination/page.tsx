    ...
    return (
        <>
            <ServiceSchema
                ...
                image="/images/services/lumination-hero.jpg"
                offers={[
                    { name: "Garden path lighting", description: "Guiding the way with invisible light sources." },
                    { name: "Architectural Uplighting", description: "Emphasizing forms of home and landscape." },
                    { name: "Aquatic Glow", description: "Underwater lighting for pools and ponds." }
                ]}
            />
            <div className="bg-night-surface text-[#f0f2ef] font-display antialiased leading-relaxed min-h-screen overflow-x-hidden relative">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-20 w-full text-center">
                        <div className="animate-in fade-in slide-in-from-bottom-10 duration-1000">
                            <div className="flex justify-center mb-6">
                                <Breadcrumbs
                                    items={[
                                        { label: t('lumination_title'), href: '/services/lumination' }
                                    ]}
                                />
                            </div>
                ...
                <section className="py-32 relative h-[80vh] overflow-hidden z-10">
                    ...
                    <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                        ...
                        <Link
                            href="/contacts?subject=Lumination"
