    ...
    return (
        <>
            <ServiceSchema
                ...
                image="/images/services/hardscaping-hero.jpg"
                offers={[
                    { name: "Pathways & Paving", description: "Precision laying of natural stone, granite, and clinker." },
                    { name: "Architectural Forms", description: "Pergolas, benches, and decorative retaining walls." },
                    { name: "Engineering", description: "Integrated drainage systems and landscape lighting." }
                ]}
            />
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-20 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-end pb-24">
                        <div className="lg:col-span-8">
                            <div className="mb-4">
                                <Breadcrumbs
                                    items={[
                                        { label: t('hardscaping_title'), href: '/services/hardscaping' }
                                    ]}
                                />
                            </div>
                ...
                <section className="py-40 relative z-10 overflow-hidden bg-hardscaping-bg">
                    ...
                    <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <Link
                                href="/contacts?subject=Hardscaping"
                                className="px-12 py-6 rounded-full bg-gradient-to-r from-hardscaping-primary to-hardscaping-primary-dark text-white font-bold tracking-widest uppercase text-xs hover:shadow-glow hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3 group"
                            >
                                {t('hardscaping_cta')}
