...
export default function GreeningPage() {
    const t = useTranslations('Greening');
    ...
    return (
        <>
            <ServiceSchema
                ...
                image="/images/services/greening-hero.jpg"
                offers={[
                    { name: "Soil Analysis", description: "Detailed soil testing and Terroir Composition analysis." },
                    { name: "Hydro-Zoning", description: "Grouping plants with similar water needs." },
                    { name: "Solar Mapping", description: "Tracking light patterns for optimal plant placement." },
                    { name: "Microclimate Adaptation", description: "Selection of plants for wind, frost, and heat resilience." }
                ]}
            />
                    ...
                    <div className="relative z-10 container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8 max-w-2xl">
                            <div className="mb-4">
                                <Breadcrumbs
                                    items={[
                                        { label: t('title'), href: '/services/greening' }
                                    ]}
                                />
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                <Link href="/contacts?subject=Greening" className="bg-golden-sand text-greening-surface px-8 py-4 rounded-full font-bold hover:brightness-110 transition-all shadow-greening-golden flex items-center justify-center gap-2 transform hover:-translate-y-1">
                                    {t('greening_cta')}
                                </Link>
